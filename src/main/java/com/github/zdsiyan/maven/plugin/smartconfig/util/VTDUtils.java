...
package com.github.zdsiyan.maven.plugin.smartconfig.util;
...
/**
 * from https://github.com/heartsome/translationstudio8/blob/master/base_plugins/net.heartsome.xml/src/net/heartsome/xml/vtdimpl/VTDUtils.java
 * @author John
 * @version
 * @since JDK1.6
 */
public class VTDUtils {
	...
	public void bind(VTDNav vn) throws NavException {
		if (vn == null) {
			throw new NavException("vtdimpl.VTDUtils.logger1");
		}
		this.vn = vn;
	}
	...
	public String getCharsetByEncoding() throws ModifyException {
		...
		case VTDNav.FORMAT_WIN_1258:
			return "Cp1258";
		default:
			throw new ModifyException("vtdimpl.VTDUtils.logger2");
		}
	}
}
